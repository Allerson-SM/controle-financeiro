...
$id = $_GET['id'];
$consulta_01 = "SELECT * FROM lancamentos WHERE ID = $id";
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <form class="row g-3" id="form-lancamento" action="componentes\editar-item.php" method="POST">
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="data" type="date" class="form-control" id="data" value="<?php echo $dado_01['DATA'] ?>">
                        </div>
                        <div class="col-md-5">
                            <label for="inputPassword4" class="form-label">Descrição</label>
                            <input name="descricao" type="text" class="form-control" id="descricao" maxlength="20" value="<?php echo $dado_01['DESCRICAO'] ?>">
                        </div>
                        <div class="col-md-3">
